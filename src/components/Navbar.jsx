...
const Navbar = () => {
  ...
  return (
    <header className="sticky top-0 z-50 backdrop-blur supports-[backdrop-filter]:bg-[color:rgb(5_11_18_/_0.6)]">
      <div className="max-w-6xl mx-auto px-6">
        <div className="flex items-center justify-between h-16">
          <a href="#home" className="flex items-center gap-2 text-[var(--text)]">
            <span className="inline-flex h-8 w-8 items-center justify-center rounded-md bg-[var(--surface)] border border-[var(--border)]">
          ...
          <nav className="hidden md:flex items-center gap-6 text-[var(--muted)]">
            ...
            <a href="#register" className="ml-4 inline-flex items-center px-4 py-2 rounded-md bg-[var(--elevated)] text-[var(--text)] border border-[var(--border)]">
              Register
            </a>
          </nav>
